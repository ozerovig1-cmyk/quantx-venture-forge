  ...
  return <section className="relative overflow-hidden bg-gradient-to-br from-primary via-accent to-teal py-12 md:py-20">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl">
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl leading-relaxed">We're a thematic Corporate Venture Accelerator: we select startups with MVP to address large enterprise pain points to develop corporate pilots that convert into startups                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                </p>
