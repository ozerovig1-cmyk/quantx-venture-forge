      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <Button size="lg" onClick={() => scrollToSection("startup-form")} className="bg-white hover:bg-white/90 font-semibold shadow-xl text-slate-700">
              Apply as Startup
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
            <Button size="lg" onClick={() => scrollToSection("corporate-form")} variant="outline" className="border-white hover:bg-white text-slate-700 font-semibold">
              Partner as Corporate
            </Button>
            <Button size="lg" onClick={() => scrollToSection("investor-form")} variant="outline" className="border-white hover:bg-white font-semibold text-slate-700">Invest with Us</Button>
          </div>
