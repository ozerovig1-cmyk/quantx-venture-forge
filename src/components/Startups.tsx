...
const Startups = () => {
  ...
  return (
    <section id="startups" className="py-20 md:py-32 bg-background">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <ValueCard
              ...
              description="Security, compliance, and procurement readiness reviews to shorten sales cycles and accelerate your path to revenue."
            />
            <ValueCard
              icon={Brain}
              title="AI Advantage"
              description="Hands-on guidance on evaluation rubrics, MLOps, data governance, and model risk management."
              accentColor="teal"
            />
            <ValueCard
              icon={Shield}
              title="Founder-First"
              description="A practical, no-fluff approach to ship, learn, and win enterprise usage. Build products customers actually pay for."
            />
          </div>
